      ...
      <td align="center" style="padding:0;">
        <table role="presentation" style="width:600px;border-collapse:collapse;border-spacing:0;text-align:left;">
          <tr style="background-color:  #ffffff;">
            <td align="center" style="padding:0px 0 0px 0; border-bottom: solid 20px #7dc858 ;">
              <!-- <img src="https://assets.codepen.io/210284/h1.png" alt="" height="300"  /> -->
              <img class="logo" role="img"
                src="https://f004.backblazeb2.com/file/pipsville-bucket/sharedasset-logo-full.png" height="100px"
                alt="yahoo">
            </td>
          </tr>
                ...
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    <h1
                      ...
                      Welcome to SharedAsset, ${name}</h1>
                    <p
...
We are thrilled to welcome you as a new member. To gain access to all of the essential features, please log in and verify your account through the settings on our website. Start enjoying your journey to financial independence today.
</p>
                    <p
                ...
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    <a target="_blank" href="${loginLink}" role="link"
                      style="font-size: 24px; padding: 10px 30px; background-color: #7dc858; font-weight: bold; color: white; text-decoration: none;">
                      login</a>
                  </td>
                </tr>
          ...
          <tr>
            ...
            <td align="left" style="vertical-align:top;">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    <td align="center" style="vertical-align:top;padding:21px 28px 17px 27px;" bgcolor="#37a402">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    <td align="center" style="vertical-align:top;padding:44px 0px 28px 0px;" bgcolor="#7dc858">
                        ...
                        <tbody>
                          <tr>
                            <td align="center"
                              ...
                              <a rel="nofollow noopener noreferrer" target="_blank" href="#"
                                ...
                                rel="nofollow noopener noreferrer" target="_blank" href="https://getsharedasset.com"
                          ...
                          <tr>
                            <td align="center"
                              ...
                              Please add <a rel="nofollow noopener noreferrer"
                                ...
                                href="https://t.me/getsharedasset_support"
                                style="color:#ffffff;text-decoration:none;"><span
                                  style="color:#ffffff;text-decoration:none;">SharedAsset Online</span></a> to
                          ...
                          <tr>
                            <td align="center"
                              ...
                              class="yiv9127454720whiteLinkText">© 2022 SharedAsset </td>
                          </tr>
                        </tbody>
                      </table>
