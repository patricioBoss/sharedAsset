const resetPasswordMailTemplate = (name = '', link) => `<!DOCTYPE html>
                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <h3
                                            style="font-size:32px;margin:0 0 20px 0;font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; font-weight:bold;line-height:32px;">
                                            ...
                                            <p
                                            style="margin:0;font-size:16px;line-height:24px;font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; ">
                                            We've received a request to reset password for this account. No changes have been made to your account yet. You can reset your password by clicking on the link below:
                                            </p>
                                            <br/>
                                            <br/>
                                            <a target="_blank" href="${link}" role="link"
                                            style="font-size: 24px; padding: 10px 30px; background-color: #1081E8; font-weight: bold; color: white; text-decoration: none; line-height:24px;">
                                            Reset Password</a>

                                            <br/>
                                            <br/>
                                        <p
                                            style="margin:0 0 25px 0;font-size:16px;line-height:24px;font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; ">
